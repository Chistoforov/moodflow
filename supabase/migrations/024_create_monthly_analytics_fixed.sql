-- Create monthly_analytics table (FIXED VERSION)
-- Fixed: psychologists.user_id is TEXT, not UUID
-- Need to join through users table or cast types
...
-- FIXED: psychologists.user_id is TEXT, need to cast or join through users table
